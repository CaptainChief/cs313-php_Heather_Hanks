...
---------------- Your code here ----------------
SELECT DISTINCT p.name FROM w5_PARTICIPANT p 
...
---------------- Your code here ----------------
SELECT DISTINCT p.id, p.name FROM w5_PARTICIPANT p 
INNER JOIN w5_EVENT_PARTICIPANT ep
ON p.id = ep.participant_id
INNER JOIN w5_EVENT e
ON e.id = ep.event_id
...
---------------- Your code here ----------------
SELECT p.name, e.name FROM w5_EVENT e 
INNER JOIN w5_EVENT_PARTICIPANT ep
ON e.id = ep.event_id
INNER JOIN w5_PARTICIPANT p
ON p.id = ep.participant_id
